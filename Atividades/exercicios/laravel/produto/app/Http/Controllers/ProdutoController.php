...
class ProdutoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        //$estado->quantidade = $request->quantidade;
     ...
     * @return \Illuminate\Http\Response
     */
    public function show(Produto $produto) // exibe um elemento só
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(Produto $produto) // vai exibir o form e servir como action de update
    {
